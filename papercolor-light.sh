...
color00="00/5f/87" # Base 00 - Black
color01="af/00/00" # Base 08 - Red
color02="00/87/00" # Base 0B - Green
color03="5f/87/00" # Base 0A - Yellow
color04="00/87/af" # Base 0D - Blue
color05="87/87/87" # Base 0E - Magenta
color06="00/5f/87" # Base 0C - Cyan
color07="44/44/44" # Base 05 - White
color08="bc/bc/bc" # Base 03 - Bright Black
color09="d7/00/00" # Base 08 - Bright Red
color10="d7/00/87" # Base 0B - Bright Green
color11="87/00/af" # Base 0A - Bright Yellow
color12="d7/5f/00" # Base 0D - Bright Blue
color13="d7/5f/00" # Base 0E - Bright Magenta
color14="00/5f/af" # Base 0C - Bright Cyan
color15="00/5f/87" # Base 07 - Bright White
...
color_foreground="00/5f/87" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pl c6c6c6 # cursor
...
echo "if !exists('g:colors_name') || g:colors_name != 'papercolor'\nset termguicolors\nset background=light\ncolorscheme papercolor\nendif" > ~/.vimrc_background

...
color01="ce/40/47" # Base 08 - Red
color02="3b/98/03" # Base 0B - Green
color03="e2/8f/43" # Base 0A - Yellow
color04="45/95/c8" # Base 0D - Blue
color05="5c/03/b0" # Base 0E - Magenta
color06="79/b7/ed" # Base 0C - Cyan
color07="00/00/00" # Base 05 - White
color08="b8/b8/b8" # Base 03 - Bright Black
color09=$color01 # Base 08 - Bright Red
color10=$color02 # Base 0B - Bright Green
color11=$color03 # Base 0A - Bright Yellow
color12="79/b7/ed" # Base 0D - Bright Blue
color13=$color05 # Base 0E - Bright Magenta
color14=$color06 # Base 0C - Bright Cyan
color15="18/18/18" # Base 07 - Bright White
color16="dc/96/56" # Base 09
color17="a1/69/46" # Base 0F
color18="f5/fa/fe" # Base 01
color19="a9/d1/ff" # Base 02
color20="fe/fd/f8" # Base 04
color21="f3/f2/fe" # Base 06
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj A9D1FF # selection color
  put_template_custom Pk 000000 # selected text color
  put_template_custom Pl 79B7ED # cursor
...
echo "if !exists('g:colors_name') || g:colors_name != 'espresso'\ncolorscheme espresso\nendif" > ~/.vimrc_background

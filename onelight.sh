...
color03="98/68/01" # Base 0A - Yellow
color04="40/78/F2" # Base 0D - Blue
color05="A6/26/A4" # Base 0E - Magenta
color06="01/84/BC" # Base 0C - Cyan
color07="A0/A1/A7" # Base 05 - White
color08="38/3A/42" # Base 03 - Bright Black
color09="E4/56/49" # Base 08 - Bright Red
color10="50/A1/4F" # Base 0B - Bright Green
color11="98/68/01" # Base 0A - Bright Yellow
color12="40/78/F2" # Base 0D - Bright Blue
color13="A6/26/A4" # Base 0E - Bright Magenta
color14="01/84/BC" # Base 0C - Bright Cyan
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 3A3F4B # selection color

...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 1f1f1f # background
  printf $printf_template_custom Pi 888888 # bold color
  printf $printf_template_custom Pj 212121 # selection color
  printf $printf_template_custom Pk F5F5F5 # selected text color
...
echo "if !exists('g:colors_name') || g:colors_name != 'mindark'\ncolorscheme mindark\nendif" > ~/.vimrc_background

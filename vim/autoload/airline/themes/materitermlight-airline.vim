...
let g:airline#themes#materitermlight#palette.normal.airline_a = ['#e5e9ea', '#40a33f', 21, 10, '']

let g:airline#themes#materitermlight#palette.insert = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#materitermlight#palette.insert.airline_a = ['#e5e9ea', '#992bae', 21, 5]

let g:airline#themes#materitermlight#palette.replace = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#materitermlight#palette.replace.airline_a = ['#e5e9ea', '#e83b3f', 21, 9]

let g:airline#themes#materitermlight#palette.visual = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#materitermlight#palette.visual.airline_a = ['#e5e9ea', '#f78c6c', 21, 17]

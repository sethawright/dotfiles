...
iabbrev vuetmpl <template><CR><div class="VueTemplate"><CR></div><CR></template><CR><CR><script><CR>export default {};<CR></script><CR><CR><style scoped lang="scss"><CR></style><C-R>=Eatchar('\s')<CR><Esc>10ki

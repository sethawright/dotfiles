...
color07="a8/99/83" # Base 05 - White
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg fbf1c7 # foreground
  put_template_custom Pi E5E9F0 # bold color
  put_template_custom Pj ebdbb2 # selection color
  put_template_custom Pk 655b53 # selected text color
